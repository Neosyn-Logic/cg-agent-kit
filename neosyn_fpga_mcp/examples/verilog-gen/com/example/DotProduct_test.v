/**
 * Title      : Generated from com.example.DotProduct_test by Neosyn IDE
 * Project    : home
 *
 * File       : com.example.DotProduct_test.v
 * Author     : nicolas06
 ...
 *
 */
module DotProduct_test(input clock, input reset_n);
  ...
  DotProduct_test_monitor monitor (
    .clock(clock),
    .reset_n(reset_n),
    .result(dut_result),
    .result_valid(dut_result_valid)
